      ...
      <div className="px-app-screen pb-3 pt-app-header">
        <div className="flex min-w-0 items-center justify-between gap-3">
          <Link
            href="/"
            prefetch={false}
            className="flex min-w-0 max-w-[min(100%,300px)] items-center gap-2.5 rounded-lg pr-1 transition-transform active:scale-[0.98]"
          ...
          <div className="flex shrink-0 items-center gap-2">
            {showMapsLink && (
              <Link
                href="/"
                className="hidden h-9 items-center rounded-lg border border-[#333] bg-[#1a1a1a] px-3 text-xs font-semibold text-[#ccc] sm:flex"
              >
                {t('map.backToMaps')}
              </Link>
            )}
