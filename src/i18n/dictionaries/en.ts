...
export const en: Dictionary = {
  ...
  home: {
    ...
    tacticsTab: {
      ...
      resumeMeet: 'Resume meet',
      activeMeetBadge: 'Active meet',
      activeMeetCode: 'Code {code}',
      activeMeetPlayers: '{count} in lobby',
      activeMeetSteps: '{count} steps',
      activeMeetNoTactic: 'Tactic selected',
      closeMeet: 'Close meet',
      closeMeetTitle: 'Close this meet?',
      closeMeetWarning:
        'The meet will be removed from this device. To rejoin, you will need the code or link from the captain again.',
      closeMeetCancel: 'Cancel',
      closeMeetConfirm: 'Close',
      createNewMeet: 'Create new meet',
    },
    newsTab: {
      title: 'What’s new',
      hint: 'Swipe between clips. Tap video to pause, hold to speed up. Description opens the map.',
      empty: 'No videos yet. Upload a lineup in admin — it will show up here.',
      toPosition: 'To spot: {position}',
      positionFrom: 'Position «{position}»',
      noDescription: 'No description',
      throwMethod: 'Throw method',
      throwMethodWithLabel: 'Throw method: {method}',
      noThrowHint: 'No throw hint provided',
      tapForDetails: 'Tap to open the lineup on the map',
      openLineup: 'Open lineup {title}',
      pauseVideo: 'Pause',
      playVideo: 'Resume',
